...
<form class="form-group" id="form" action="clmodifyuser.php" method="post" onsubmit="return validation();">
...
<tr>
  ...
  <td>
    <textarea cols="25" rows="5" style="margin-bottom: 10px;" class="form-control"  required="" name="Description" data-validation="custom" value=><?php echo $row[4]; ?></textarea>
  </td>
  </tr>
  <tr>
  <td>Date:</td>
  ...
  <td>
    <input type="text" style="margin-bottom: 10px;" class="form-control" value="<?php echo $row[7]; ?>" required="" name="Crime_date"  data-validation="custom"/>
  </td>
</tr>
  <td>
    Crime place
