            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="crregistration.php">Register</a></li>                       
	...
	<section id="services" class="service-item">
	   <div class="container">
            <div class="center wow fadeInDown">
                <h2>About us</h2>
                <p class="lead">Online Crime Reporting brings you the hassle free, easiest way of Online Complaint Registration and crime reporting. The website is linked with all the police stations spread over the state.<br> Use the rightmost tabs for registering the complaint, for viewing the complaint and share you information.</p>
            </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap wow fadeInDown">
                        ...
                        <div class="media-body">
                            ...
                            <p>One can register the complaint under crime management system</p>
                        </div>
                    </div>
                </div>
